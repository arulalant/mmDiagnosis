...
def makeProjectedPctsAmplitudePhases(rawOrAnomaly='Anomaly',
             filteredOrNot='Filtered', seasons=['jjas'], **kwarg):
...
if __name__ == '__main__':
    ...
    fname = 'PC-Time-Series-I_and_II_Rainfall.nc'
    outfile = 'Amplitude_Phase_PCTS-I_and_II_Rainfall.nc'
    genMjoAmplitudePhases(infile=fname, outfile=outfile,
                     pcs1VarName='pct1', pcs2VarName='pct2', pcs2Sign=-1)
