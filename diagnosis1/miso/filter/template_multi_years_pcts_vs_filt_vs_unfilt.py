...
#    print 'y =', y 
    for i in range(Nrows):	
    	for j in range(Ncols):
            ...
            template.comment1.x = xmove+x-0.37
            template.comment1.y = ymove+y+0.05
            
            template.comment2.priority = 1
            template.comment2.texttable = tt
            template.comment2.textorientation = tt1
            template.comment2.x = xmove+x-0.1
            template.comment2.y = ymove+y+0.21
