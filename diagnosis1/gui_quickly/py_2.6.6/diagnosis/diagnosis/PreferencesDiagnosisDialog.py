...
class PreferencesDiagnosisDialog(gtk.Dialog):
    __gtype_name__ = "PreferencesDiagnosisDialog"
    preferences = {}
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated PreferencesDiagnosisDialog object.
        """
        builder = get_builder('PreferencesDiagnosisDialog')
        new_object = builder.get_object("preferences_diagnosis_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a PreferencesDiagnosisDialog object with it in order to
        finish initializing the start of the new PerferencesDiagnosisDialog
        instance.
...
if __name__ == "__main__":
    dialog = PreferencesDiagnosisDialog()
    dialog.show()
    gtk.main()
