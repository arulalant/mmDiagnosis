...
lon5 = {0: '0E', 5: '5E', 10: '10E', 15: '15E', 20: '20E',
        ...
        160: '160E', 160: '160E', 165: '165E', 170: '170E', 175: '175E',
...
lon10 = {0: '0E', 10: '10E', 20: '20E', 30: '30E', 40: '40E', 50: '50E',
        ...
        160: '160E', 170: '170E', 180: '180E', 190: '190E', 200: '200E',
...
def compute_RMS_function (rs, s, R):
    """
    Function compute_RMS_function
    -----------------------------
    ...
    Input:
        rs:   reference-variable standard deviation (taking input from
                the tylor template.referencevalue as reference_std_dev)
        s:      test variable standard deviation
        R:      test-variable correlation with reference variable
    """

    RMS_2 = rs*rs + s*s - 2*rs*s*R
    # Compute square root
    return RMS_2** 0.5
...
def tylorPlot(data, reference, name, path=None, colors=[], symbols=[], 
    ...
    if rms in ['yes', 'y', 1, True]:
        ...
        x.plot (data, gentylor, tytemp, skill = compute_RMS_function,
